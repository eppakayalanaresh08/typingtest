    ...
    <div className="typing-app">
      ...
      <div className="wrapper">
        <button className="button is-dark dark__mode" onClick={switchTime}>
          <span className="timer">Timer </span>: {SECONDS} Seconds
        </button>
      </div>
      <div className="section">
        <i class="fa-duotone fa-moon"></i>
        <div className="is-size-1 has-text-centered has-text-primary">
        <img src="https://assets.ccbp.in/frontend/dynamic-webapps/clock-img.png" alt="clock" class="image-timer mr-2"/>

          <h2 className="count-start">{countDown}</h2>
        </div>
      </div>
